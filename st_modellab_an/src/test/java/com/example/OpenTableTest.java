...
public class OpenTableTest {
    ...
    public void BeforeMethod() throws Exception {
        PropertyConfigurator.configure("C:\\Users\\Admin\\Desktop\\st_modellab_an\\src\\log4j.prperties");
    ...
    public String[][] data() throws Exception {
        ...
        FileInputStream fis = new FileInputStream(
                "C:\\Users\\Admin\\Desktop\\modellab_excelsheet.xlsx");
    ...
    public void Test(String a) throws Exception {
        ...
        Thread.sleep(2000);
        driver.findElement(By.xpath("//*[@id=\"mainContent\"]/div/div/div[2]/div[1]/div[2]/div[1]/div[1]/a/h6"))
                .click();
        Thread.sleep(2000);
        ...
        Thread.sleep(2000);
        WebElement nextbut = driver.findElement(
                By.xpath("//*[@id=\"restProfileMainContentDtpDayPicker-wrapper\"]/div/div/div/div/div[2]/button[2]"));
        for (int i = 0; i < 8; i++, Thread.sleep(2000))
            nextbut.click();
        driver.findElement(By.xpath(
                "//*[@id=\"restProfileMainContentDtpDayPicker-wrapper\"]/div/div/div/table/tbody/tr[3]/td[2]/button"))
                .click();
        Thread.sleep(2000);
